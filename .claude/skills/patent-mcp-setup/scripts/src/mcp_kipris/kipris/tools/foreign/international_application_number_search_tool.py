# [Original] Foreign patent international application number search tool
...
class ForeignPatentInternationalApplicationNumberSearchArgs(ForeignSearchMixin):
...
class ForeignPatentInternationalApplicationNumberSearchTool(ToolHandler):
    def __init__(self):
        ...
        self.api = ForeignPatentInternationalApplicationNumberSearchAPI(api_key=get_api_key())
    ...
    async def _execute_async(
        self, validated_args: ForeignPatentInternationalApplicationNumberSearchArgs
    ) -> pd.DataFrame:
