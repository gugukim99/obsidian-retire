# [Original] Foreign patent applicant search API
...
class ForeignPatentApplicantSearchAPI(ABSKiprisAPI):
    """Foreign patent search by applicant name."""

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.api_url = "http://plus.kipris.or.kr/openapi/rest/ForeignPatentAdvancedSearchService/applicantSearch"
    ...
    def _build_params(
        ...
        **kwargs,
        ...
        """[GJ] Build API parameters for foreign applicant search."""
