# [Original] Foreign patent application number search API
...
class ForeignPatentApplicationNumberSearchAPI(ABSKiprisAPI):
    """Foreign patent search by application number."""

    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.api_url = (
            "http://plus.kipris.or.kr/openapi/rest/ForeignPatentAdvancedSearchService/applicationNumberSearch"
        )
    ...
    def _build_params(
        ...
        **kwargs,
        ...
        """[GJ] Build API parameters for foreign application number search."""
