# [Original] Korean patent right holder search API
...
class PatentRighterSearchAPI(ABSKiprisAPI):
    """Korean patent search by right holder name.

    Note: The KIPRIS API parameter name is 'rightHoler' (with typo).
    """
    ...
    def _build_params(
        ...
        **kwargs,
        ...
        """[GJ] Build API parameters for right holder search.

        Args:
            rightHoler: Right holder name (API param name has typo).
        """
